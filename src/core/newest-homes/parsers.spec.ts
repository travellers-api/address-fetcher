...
describe('parseHomeSearchPage', () => {
  test('homes', async () => {
    const html = `  <section class="mb-3">
    <div class="container overflow-hidden">
      <h2 class="mb-3">すべての家</h2>
      <div class="row block-homes">
...
<li class="page-item">
  <a class="page-link" href="/homes/search?page=2">2</a>
</li>
...
<li class="page-item">
<a class="page-link" href="/homes/search?page=2">
  <span aria-hidden="true">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
         stroke="#CF761D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<li class="page-item">
<a class="page-link" href="/homes/search?page=10">
  <span aria-hidden="true">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
         stroke="#CF761D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  test('empty', async () => {
    ...
    <div class="l-wrap l-done">
      <div class="l-container">
        <div class="l-inner">
          <img src="https://cdn.address.love/packs/media/images/Icon-check-done-2b4bb3cafe9c659406c4f7e0f690cac8.svg" alt="" class="">
          <p class="title">家が見つかりませんでした</p>
